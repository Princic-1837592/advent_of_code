...
version = "0.1.0"
authors = ["Andrea Princic <andreapri.99@gmail.com>"]
edition = "2021"
				...
				with open(path, "w") as day_input:
					if auto_download and keep_downloading:
						response = get(
							...
							headers={
								"User-Agent": "https://github.com/Princic-1837592/advent_of_code/blob/main/setup.py by andreapri.99@gmail.com"
							},
						)
...
if __name__ == "__main__":
	setup_calendar("2025", "rust", False, True)
